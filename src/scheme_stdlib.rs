...
pub fn register_stdlib(env: &mut Environment) {
    let builtins = vec![
        ...
        // Type predicates
        ("number?", SVal::BuiltinProc {
            name: "number?".to_string(),
            arity: Some(1),
        }),
        ("symbol?", SVal::BuiltinProc {
            name: "symbol?".to_string(),
            arity: Some(1),
        }),
        ("pair?", SVal::BuiltinProc {
            name: "pair?".to_string(),
            arity: Some(1),
        }),
        ("null?", SVal::BuiltinProc {
            name: "null?".to_string(),
            arity: Some(1),
        }),
        // List operations
        ("car", SVal::BuiltinProc {
            name: "car".to_string(),
            arity: Some(1),
        }),
        ("cdr", SVal::BuiltinProc {
            name: "cdr".to_string(),
            arity: Some(1),
        }),
        ("cons", SVal::BuiltinProc {
            name: "cons".to_string(),
            arity: Some(2),
        }),
        ("list", SVal::BuiltinProc {
            name: "list".to_string(),
            arity: None,
        }),
        ("length", SVal::BuiltinProc {
        ...
        ("append", SVal::BuiltinProc {
            name: "append".to_string(),
            arity: None,
        }),
        ("atom?", SVal::BuiltinProc {
            name: "atom?".to_string(),
            arity: Some(1),
        }),
        // I/O
        ("display", SVal::BuiltinProc {
            name: "display".to_string(),
            arity: None,
        }),
        ("newline", SVal::BuiltinProc {
            name: "newline".to_string(),
            arity: Some(0),
        }),
        // Mathematical functions
        ("abs", SVal::BuiltinProc {
            name: "abs".to_string(),
            arity: Some(1),
        }),
        ("floor", SVal::BuiltinProc {
            name: "floor".to_string(),
            arity: Some(1),
        }),
        ("ceiling", SVal::BuiltinProc {
            name: "ceiling".to_string(),
            arity: Some(1),
        }),
        ("round", SVal::BuiltinProc {
            name: "round".to_string(),
            arity: Some(1),
        }),
        ("truncate", SVal::BuiltinProc {
            name: "truncate".to_string(),
            arity: Some(1),
        }),
        ("sqrt", SVal::BuiltinProc {
            name: "sqrt".to_string(),
            arity: Some(1),
        }),
        ("sin", SVal::BuiltinProc {
            name: "sin".to_string(),
            arity: Some(1),
        }),
        ("cos", SVal::BuiltinProc {
            name: "cos".to_string(),
            arity: Some(1),
        }),
        ("tan", SVal::BuiltinProc {
            name: "tan".to_string(),
            arity: Some(1),
        }),
        ("log", SVal::BuiltinProc {
            name: "log".to_string(),
            arity: Some(1),
        }),
        ("exp", SVal::BuiltinProc {
            name: "exp".to_string(),
            arity: Some(1),
        }),
        ("min", SVal::BuiltinProc {
            name: "min".to_string(),
            arity: None,
        }),
        ("max", SVal::BuiltinProc {
            name: "max".to_string(),
            arity: None,
        }),
        // String functions
        ("string?", SVal::BuiltinProc {
            name: "string?".to_string(),
            arity: Some(1),
        }),
        ("string-length", SVal::BuiltinProc {
            name: "string-length".to_string(),
            arity: Some(1),
        }),
        ("substring", SVal::BuiltinProc {
            name: "substring".to_string(),
            arity: Some(3),
        }),
        ("string-upcase", SVal::BuiltinProc {
            name: "string-upcase".to_string(),
            arity: Some(1),
        }),
        ("string-downcase", SVal::BuiltinProc {
            name: "string-downcase".to_string(),
            arity: Some(1),
        }),
        ("string-append", SVal::BuiltinProc {
            name: "string-append".to_string(),
            arity: None,
        }),
        ("string->number", SVal::BuiltinProc {
            name: "string->number".to_string(),
            arity: Some(1),
        }),
        ("number->string", SVal::BuiltinProc {
